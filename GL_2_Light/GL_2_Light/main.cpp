...
const GLuint S_WIDTH = 800, S_HEIGHT = 600;
// Camera
...
//        view = glm::translate(view, glm::vec3(.3f, 0.5f, -6.f));
        glm::mat4 projection = glm::perspective(glm::radians(45.f), (GLfloat)S_WIDTH / (GLfloat)S_HEIGHT, 0.1f, 100.0f);
